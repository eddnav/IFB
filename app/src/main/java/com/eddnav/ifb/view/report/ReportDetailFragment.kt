...
class ReportDetailFragment : Fragment() {
    ...
    private fun populate(report: Report) {
        ...
        t1h.text = getString(R.string.value_2f).format(report.hydrationSchedule.total[1])
        t2h.text = getString(R.string.value_2f).format(report.hydrationSchedule.total[2])
